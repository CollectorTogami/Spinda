...
class SM83Core:
    ...
    @property
    def f(self):
        # The local bindings need the packed flag byte, not the helper wrapper,
        # so Python register dumps match the real SM83 flag register.
        return self._native.f.packed
