...
public:
	...
	void setShowFrameCounter(bool showFrameCounter) { m_showFrameCounter = showFrameCounter; }
	void setShowInputDisplay(bool showInputDisplay) { m_showInputDisplay = showInputDisplay; }
	bool finalizeVAO();
	void reset();
...
public slots:
	...
	void showInputDisplay(bool enable) override;
...
public slots:
	...
	void showInputDisplay(bool enable);
