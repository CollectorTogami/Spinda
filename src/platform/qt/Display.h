...
public:
	...
	bool isShowInputDisplay() const { return m_showInputDisplay; }
	bool isPresentationEnabled() const { return m_presentationEnabled; }
...
public slots:
	...
	virtual void showInputDisplay(bool enable);
	...
	virtual void setPresentationEnabled(bool enable) { m_presentationEnabled = enable; }
