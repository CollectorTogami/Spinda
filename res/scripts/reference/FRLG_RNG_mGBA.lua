-- Local provenance note (2026-04-26):
-- Exact reference copy from Real96/PokeLua `Gen 3/mGBA/FRLG_RNG_mGBA.lua`.
-- Upstream repository declares GPL-3.0. Do not treat this as locally authored
-- mGBA code; public release must include matching GPL notice/source attribution
-- or remove this reference copy.
